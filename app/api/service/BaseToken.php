...
use app\commom\exception\ForbiddenException;
use think\Exception;
use app\commom\enum\ScopeEnum;
...
class BaseToken{
    ...
    public static function getCurrentVarByToken($key){
        ...
        // $arr = explode(' ', $bearerToken);

        $arr=$bearerToken ? explode(' ',$bearerToken) : $bearerToken;
        ...
        if(!$values){
            ...
            if(array_key_exists($key,$values)){
                ...
                throw new Exception('尝试获取的值不存在,请联系管理员!');
            }
        }
    }
